    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <button
          ...
          className="touch-target flex items-center justify-center rounded-xl text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-zinc-50"
        >
          {theme === "light" ? (
